...
public class ClimbRotator extends SubsystemBase {
  ...
  public ClimbRotator(boolean isLeft) {
    ...
    if (isLeft) {
      ...
      m_motor = ControllerFactory.createTalonFX(constants.kArmLeftMotor, false); // initializes the motor
    ...
    // otherwise, use the normal encoder value and set the motorports to the right
      ...
      m_motor = ControllerFactory.createTalonFX(constants.kArmRightMotor, false); // initializes the motor
