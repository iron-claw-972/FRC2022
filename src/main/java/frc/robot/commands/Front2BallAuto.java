...
public class Front2BallAuto extends SequentialCommandGroup {
  ...
  public Front2BallAuto(double distance, boolean intakeSecond, boolean shootSecond , boolean isRedBall) {
