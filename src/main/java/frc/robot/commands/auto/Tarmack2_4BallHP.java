...
public class Tarmack2_4BallHP extends SequentialCommandGroup {
  public Tarmack2_4BallHP() {
    this(Robot.drive, Robot.belt, Robot.arm, Robot.shooter, Robot.ballDetection);
  }

  public Tarmack2_4BallHP(Drivetrain drive, Belt belt, Arm arm, Shooter shooter, BallDetection ballDetection) {
