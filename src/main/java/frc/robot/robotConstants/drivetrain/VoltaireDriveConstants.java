...
public class VoltaireDriveConstants {
  public final int[] rightMotorPorts = {6, 7};
  public final int[] leftMotorPorts = {4, 5};
  ...
  public final int kSupplyCurrentLimit = 40;
  public final int kSupplyTriggerThreshold = 50;
  public final int kSupplyTriggerDuration = 1;
